...
const Profile = () => {
  return (
    <div className="flex flex-col xl:flex-row items-center xl:items-start xl:justify-between gap-4 p-2 sm:p-5 w-screen  h-screen overflow-x-hidden overflow-y-scroll no-scrollbar ">
